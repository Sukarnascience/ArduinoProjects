...
void sortColor(int red, int green, int blue){
  ...
  if(red<48 && red>39 && green<138 && green>128){
    dropServo.write(50); // red
  }
  else if(green<48 && green>40 && blue<56 && blue>49){
    dropServo.write(75); // Orange
  }
  else if(red<50 && red>43 && green<40 && green>30){
    dropServo.write(100); // Green
  }
  else if(red<25 && red>15 && green<40 && green>30){
    dropServo.write(125); // Yellow
  }
  else if(red<50 && red>40 && green<58 && green>48){
    dropServo.write(150); // purple
  }
  else if (green<30 && green>20 && blue<25 && blue>18){
